...
class Superquadric:
    def __init__(self):
        ...
        self.roll = gui.NumberEdit(gui.NumberEdit.DOUBLE)
        self.pitch = gui.NumberEdit(gui.NumberEdit.DOUBLE)
        self.yaw = gui.NumberEdit(gui.NumberEdit.DOUBLE)
    ...
    def set_values(self, scale, position, epsilon1, epsilon2, rotation):
        ...
        self.roll.set_value(rotation[0])
        self.pitch.set_value(rotation[1])
        self.yaw.set_value(rotation[2])
    ...
    def visualize_superquadrics(self):
        ...
        for i in range(len(self.sqs)):
            ...
            if a1 * a2 * a3 != 0:
                ...
                y = sq.y.double_value
                z = sq.z.double_value
                roll = sq.roll.double_value
                pitch = sq.pitch.double_value
                yaw = sq.yaw.double_value
    ...
    def save_object(self):
        ...
        for sq in self.sqs:
            if sq.a1.double_value == 0 or sq.a2.double_value == 0 or sq.a3.double_value == 0:
                continue
            sq_data = {
                "e1": round(sq.e1.double_value, 2),
                "e2": round(sq.e2.double_value, 2),
                "a1": round(sq.a1.double_value, 2),
                "a2": round(sq.a2.double_value, 2),
                "a3": round(sq.a3.double_value, 2),
                "x": round(sq.x.double_value, 2),
                "y": round(sq.y.double_value, 2),
                "z": round(sq.z.double_value, 2),
                "roll": round(sq.roll.double_value, 2),
                "pitch": round(sq.pitch.double_value, 2),
                "yaw": round(sq.yaw.double_value, 2)
            }
